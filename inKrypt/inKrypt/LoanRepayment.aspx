<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="LoanRepayment.aspx.cs" Inherits="LoanRepayment" %>
    ...
    <div>
        ...
        <div class="row">
            <div class="col-md-6 text-right">
                <asp:Button ID="btnRepay" runat="server" Text="Repay" CssClass="btn btn-primary" OnClick="btnRepay_Click" />
            </div>
        </div>
    </div>
